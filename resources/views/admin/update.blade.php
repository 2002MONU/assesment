        ...
        <div class="row">
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.update-book',$author->id)}}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label class="form-label" for="email">Book Name</label>
                                <input type="book_name" class="form-control" id="book_name" name="book_name"  value="{{$author->book_name}}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="author_id" id="" class="form-control">
                                    ...
                                    <option value="{{ $user->id }}" {{ $author->author_id ===  $user->id ? 'selected' : '' }}>
                                        {{ $user->author_name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="book_name" class="form-control" id="book_name" name="title"  value="{{$author->title}}">
                                @if($errors->has('title'))
