                        ...
                        <div class="auth-form">
                          ...
                          @endif
                                ...
                                <form action="{{route('user-post')}}" method="POST">
                                    ...
                                    <div class="form-floating mb-3 mt-4">
                                        <input type="number" class="form-control"  name="mobile" id="floatingInput" placeholder="name@example.com">
                                    ...
                                    <div class="text-center mt-3">
                                        <button type="sumbit" name="sumbit" class="btn btn-primary">Sign Up</button>
                                    </div>
                                    <div class="text-center mt-3">
